// Rabbit stream cipher - initially included in luazen 2016-04-13
...
// the following copyright notice was included in the original ECRYPT 
// submission. It has been kept as is. See the link above for the
// actual public domain release.

// (end of luazen comment)
